...
describe('auth form',  () => {
	...
	it('Test #2 - should demonstrate Login page with invalid password ', async () => {
	...
	it('Test #3 - should demonstrate Login with  invalid login ', async () => {
        await loginPage.open();
		await loginPage.fillUserName('standard_user');
	...
	it('Test #1 - should demonstrate Login  with Valid Login ', async () => {
        await loginPage.open();
		await loginPage.fillUserName('standard_user');
		await loginPage.fillPassword('secret_sauce');
		await loginPage.clickLoginBtn();
		//await expect(elem).toExist()
		await loginPage.checkExpectUrl('https://www.saucedemo.com/inventory.html')
		//await loginPage.checkExistElem ('burgerMenu', "$('#react-burger-menu-btn')" ) 
		
	})

	it('Test #4 - should demonstrate Login with Logout ', async () => {
        await loginPage.open();
		await loginPage.login('standard_user', 'secret_sauce');
		await loginPage.checkExpectUrl('https://www.saucedemo.com/inventory.html')
		await loginPage.checkBadgeCart();
		await browser.pause(2000);
		await loginPage.isDispBurgerElem();
		await loginPage.logout();
		await loginPage.chkEmpty();

		})

	it('Test #5 - should demonstrate Saving the card after logout  ', async () => {
        await loginPage.open();
		await loginPage.login('standard_user', 'secret_sauce');
		await loginPage.checkExpectUrl('https://www.saucedemo.com/inventory.html')
		await loginPage.checkBadgeCart();
		await browser.pause(2000);
		await loginPage.logout();
		await loginPage.checkExpectUrl('https://www.saucedemo.com/')
		await loginPage.login('standard_user', 'secret_sauce');
		await loginPage.checkExpectUrl('https://www.saucedemo.com/inventory.html')
		await browser.saveScreenshot('./screenshot_SaveCartAfterLogout');
		await loginPage.checkBadgeCart();
	})

	it('Test #6 - should demonstrate Sorting ', async () => {
        await loginPage.open();
		await loginPage.login('standard_user', 'secret_sauce');
		await loginPage.checkExpectUrl('https://www.saucedemo.com/inventory.html')
		await loginPage.dropDownList('select.product_sort_container')
	})

	it('test #7 - should demonstrate Footer Links - Twitter, Facebook, Linkedin', async () => {
		await loginPage.open();
		await loginPage.login('standard_user', 'secret_sauce');
		browser.pause(2000)
		await loginPage.clickSocial(url_stand);
		await browser.pause(4000);
	})
	it('Test #8 - should demonstrate Valid Checkout ', async () => {
		await loginPage.open();
		await loginPage.login('standard_user', 'secret_sauce');
		await loginPage.checkExpectUrl('https://www.saucedemo.com/inventory.html')
		await loginPage.checkBadgeCart();
		await browser.pause(2000);
		await loginPage.orderCart();
	})
	it('Test #9 - should demonstrate Checkout without products	', async () => {
		await loginPage.open();
		await loginPage.login('standard_user', 'secret_sauce');
		await loginPage.checkExpectUrl('https://www.saucedemo.com/inventory.html')
		await loginPage.ErrOrderCart()
	})
	
	it('Test #10 - should demonstrate placing an order - ' , async () => {
        await loginPage.open();
		await loginPage.login('standard_user', 'secret_sauce');
		await loginPage.checkExpectUrl('https://www.saucedemo.com/inventory.html')
		await loginPage.ErrOrderCartStepOne()
